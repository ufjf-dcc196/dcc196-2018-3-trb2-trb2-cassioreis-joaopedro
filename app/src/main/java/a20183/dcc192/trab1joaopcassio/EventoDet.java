...
public class EventoDet extends AppCompatActivity {
    ...
    private Cursor getEventosParticipantes()
    {
        ...
        String restricoes = ParticipacaoContract.Participacao.COLUMN_NAME_EVENTO + " = ?";
    ...
    private Cursor getEvento()
    {
        ...
        String restricoes = EventoContract.Evento.COLUMN_NAME_TITULO + " = ?";
        String params[] = {titulo};
        return db.query(EventoContract.Evento.TABLE_NAME, visao,restricoes,params,null,null, sort);
    }
